...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('group_messaging_message', 'senders_info', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Message.senders_info'
        db.alter_column('group_messaging_message', 'senders_info', self.gf('django.db.models.fields.CharField')(max_length=64))
