...
try:
    ...
    email_feed_setting_model = 'askbot.EmailFeedSetting'
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for user in orm['auth.User'].objects.all():
            ...
            new_feed.save()
            verbose_frequency = force_text(dict(const.NOTIFICATION_DELIVERY_SCHEDULE_CHOICES)[frequency])
            print('added \'%s\' subscription for %s (%d)' % (
                                                            force_text(verbose_frequency),
