...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Group',
            fields=[
                ('group_ptr', models.OneToOneField(auto_created=True, to='auth.Group', primary_key=True, parent_link=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_question_id', models.PositiveIntegerField(unique=True, blank=True, null=True, default=None)),
                ('old_answer_id', models.PositiveIntegerField(unique=True, blank=True, null=True, default=None)),
                ('old_comment_id', models.PositiveIntegerField(unique=True, blank=True, null=True, default=None)),
                ('added_at', models.DateTimeField(default=django.utils.timezone.now)),
                ...
                ('text', models.TextField(null=True)),
                ('language_code', models.CharField(default='ko-kr', max_length=16, choices=[('ko-kr', 'Korean'), ('en-us', 'English')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagnames', models.CharField(default='', blank=True, max_length=125)),
                ('is_anonymous', models.BooleanField(default=False)),
                ('ip_addr', models.GenericIPAddressField(default='0.0.0.0', db_index=True)),
                ('approved_by', models.ForeignKey(blank=True, null=True, to=settings.AUTH_USER_MODEL)),
                ('author', models.ForeignKey(to=settings.AUTH_USER_MODEL, related_name='postrevisions')),
                ('post', models.ForeignKey(blank=True, null=True, to='askbot.Post', related_name='revisions')),
            ],
            options={
                'ordering': ('-revision',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, null=True, to='askbot.Group')),
            ],
        ),
        migrations.CreateModel(
            name='ReplyAddress',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(blank=True, null=True, to='askbot.Post')),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_by', models.ForeignKey(blank=True, null=True, to=settings.AUTH_USER_MODEL, related_name='deleted_tags')),
                ('suggested_by', models.ManyToManyField(help_text='Works only for suggested tags for tag moderation', related_name='suggested_tags', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_at', models.DateTimeField(auto_now_add=True)),
                ('points', models.IntegerField(default=0, db_column='score')),
                ('accepted_answer', models.ForeignKey(blank=True, null=True, to='askbot.Post', related_name='+')),
                ('closed_by', models.ForeignKey(blank=True, null=True, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, to='askbot.PostRevision', related_name='rendered_posts'),
        ),
        migrations.AddField(
            model_name='post',
            name='deleted_by',
            field=models.ForeignKey(blank=True, null=True, to=settings.AUTH_USER_MODEL, related_name='deleted_posts'),
        ),
        migrations.AddField(
            model_name='post',
            name='endorsed_by',
            field=models.ForeignKey(blank=True, null=True, to=settings.AUTH_USER_MODEL, related_name='endorsed_posts'),
        ),
        migrations.AddField(
            model_name='post',
            name='groups',
        ...
        migrations.AddField(
            model_name='post',
            name='last_edited_by',
            field=models.ForeignKey(blank=True, null=True, to=settings.AUTH_USER_MODEL, related_name='last_edited_posts'),
        ),
        migrations.AddField(
            model_name='post',
            name='locked_by',
            field=models.ForeignKey(blank=True, null=True, to=settings.AUTH_USER_MODEL, related_name='locked_posts'),
        ),
        migrations.AddField(
            model_name='post',
            name='parent',
            field=models.ForeignKey(blank=True, null=True, to='askbot.Post', related_name='comments'),
        ),
        migrations.AddField(
            model_name='post',
            name='thread',
            field=models.ForeignKey(blank=True, null=True, to='askbot.Thread', default=None, related_name='posts'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='group',
            name='description',
            field=models.OneToOneField(blank=True, null=True, to='askbot.Post', related_name='described_group'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(blank=True, null=True, to='askbot.Group'),
        ),
        migrations.AddField(
            model_name='askwidget',
            name='tag',
            field=models.ForeignKey(blank=True, null=True, to='askbot.Tag'),
        ),
        migrations.AddField(
