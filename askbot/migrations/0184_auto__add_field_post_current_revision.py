...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.current_revision'
        db.add_column('askbot_post', 'current_revision',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rendered_posts', null=True, to=orm['askbot.PostRevision']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.current_revision'
        db.delete_column('askbot_post', 'current_revision_id')
