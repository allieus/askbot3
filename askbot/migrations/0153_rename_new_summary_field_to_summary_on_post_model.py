...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('askbot_post', 'new_summary', 'summary')

    def backwards(self, orm):
        db.rename_column('askbot_post', 'summary', 'new_summary')
    ...
    models = {
        ...
        'askbot.post': {
            ...
            'new_summary': ('django.db.models.fields.TextField', [], {'null': 'True'}),
