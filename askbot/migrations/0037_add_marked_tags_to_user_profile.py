...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        safe_add_column('auth.user', 'interesting_tags', self.gf('django.db.models.fields.TextField')(blank=True, default = ''), keep_default=False)
        # Adding field 'User.ignored_tags'
        safe_add_column('auth.user', 'ignored_tags', self.gf('django.db.models.fields.TextField')(blank=True, default = ''), keep_default=False)
