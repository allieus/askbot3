...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('question', 'closed_at')

        # Deleting field 'Question.closed_by'
        db.delete_column('question', 'closed_by_id')

        # Deleting field 'Question.close_reason'
        db.delete_column('question', 'close_reason')

        # Deleting field 'Question.closed'
        db.delete_column('question', 'closed')


    def backwards(self, orm):

        # Adding field 'Question.closed_at'
        db.add_column('question', 'closed_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Question.closed_by'
        db.add_column('question', 'closed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='closed_questions', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Adding field 'Question.close_reason'
        db.add_column('question', 'close_reason', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Question.closed'
        db.add_column('question', 'closed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
