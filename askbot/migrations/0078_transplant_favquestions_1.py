...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('favorite_question', 'thread', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Thread'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'FavoriteQuestion.thread'
        db.delete_column('favorite_question', 'thread_id')
