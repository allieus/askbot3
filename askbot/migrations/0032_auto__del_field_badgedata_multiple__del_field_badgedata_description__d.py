...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding field 'BadgeData.description'
        db.add_column('askbot_badgedata', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=300), keep_default=False)

        # Adding field 'BadgeData.type'
        db.add_column('askbot_badgedata', 'type', self.gf('django.db.models.fields.SmallIntegerField')(default=3), keep_default=False)

        # Adding field 'BadgeData.name'
        db.add_column('askbot_badgedata', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Changing field 'BadgeData.slug'
        db.alter_column('askbot_badgedata', 'slug', self.gf('django.db.models.fields.SlugField')(blank=True, max_length=50))
