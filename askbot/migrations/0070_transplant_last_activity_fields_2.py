...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('question', 'last_activity_by_id')

        # Deleting field 'Question.last_activity_at'
        db.delete_column('question', 'last_activity_at')
    ...
    def backwards(self, orm):
        ...
        db.add_column('question', 'last_activity_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)
