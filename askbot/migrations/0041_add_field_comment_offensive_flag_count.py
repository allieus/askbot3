...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('comment', 'offensive_flag_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Comment.offensive_flag_count'
        db.delete_column('comment', 'offensive_flag_count')
