...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('question_revision', 'is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Question.is_anonymous'
        db.add_column('question', 'is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('question_revision', 'is_anonymous')

        # Deleting field 'Question.is_anonymous'
        db.delete_column('question', 'is_anonymous')
