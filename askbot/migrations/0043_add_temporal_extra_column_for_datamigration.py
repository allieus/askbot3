...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        safe_add_column('auth.user', 'avatar_type', self.gf('django.db.models.fields.CharField')(max_length=1, default='n'), keep_default=False)

    def backwards(self, orm):
        db.delete_column('auth.user', 'avatar_type')
