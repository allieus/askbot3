...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BadgeData.display_order'
        db.add_column('askbot_badgedata', 'display_order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BadgeData.display_order'
        db.delete_column('askbot_badgedata', 'display_order')
