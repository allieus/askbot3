...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('badge', 'askbot_badgedata')
        db.create_unique('askbot_badgedata', ['type', 'name'])
        # Changing field 'Award.badge'
        db.alter_column('award', 'badge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.BadgeData']))


    def backwards(self, orm):

        db.rename_table('askbot_badgedata', 'badge')
        db.create_unique('badge', ['type', 'name'])
        # Changing field 'Award.badge'
        db.alter_column('award', 'badge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Badge']))
