...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('question', 'thread', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='questions', unique=True, null=True, to=orm['askbot.Thread']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('question', 'thread_id')
