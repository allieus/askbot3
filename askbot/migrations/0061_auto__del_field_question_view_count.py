...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('question', 'view_count')


    def backwards(self, orm):

        # Adding field 'Question.view_count'
        db.add_column('question', 'view_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
