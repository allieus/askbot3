...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnonymousQuestion.ip_addr'
        db.alter_column('askbot_anonymousquestion', 'ip_addr', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))

        # Changing field 'AnonymousAnswer.ip_addr'
        db.alter_column('askbot_anonymousanswer', 'ip_addr', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))

        # Changing field 'PostRevision.ip_addr'
        db.alter_column('askbot_postrevision', 'ip_addr', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))

    def backwards(self, orm):

        # Changing field 'AnonymousQuestion.ip_addr'
        db.alter_column('askbot_anonymousquestion', 'ip_addr', self.gf('django.db.models.fields.IPAddressField')(max_length=15))

        # Changing field 'AnonymousAnswer.ip_addr'
        db.alter_column('askbot_anonymousanswer', 'ip_addr', self.gf('django.db.models.fields.IPAddressField')(max_length=15))

        # Changing field 'PostRevision.ip_addr'
        db.alter_column('askbot_postrevision', 'ip_addr', self.gf('django.db.models.fields.IPAddressField')(max_length=15))
    ...
    models = {
        ...
        'askbot.post': {
            ...
            'endorsed_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'endorsed_posts'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_anonymous': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'language_code': ('django.db.models.fields.CharField', [], {'default': "'ru'", 'max_length': '16'}),
