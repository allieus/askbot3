...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('vote', 'voted_post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='post_votes', null=True, to=orm['askbot.Post']), keep_default=False)

        # Adding field 'Activity.question_post'
        db.add_column('activity', 'question_post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Post'], null=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Vote.voted_post'
        db.delete_column('vote', 'voted_post_id')

        # Deleting field 'Activity.question_post'
        db.delete_column('activity', 'question_post_id')
