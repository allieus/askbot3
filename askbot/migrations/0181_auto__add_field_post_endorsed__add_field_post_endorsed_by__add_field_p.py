...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.endorsed'
        db.add_column('askbot_post', 'endorsed',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Post.endorsed_by'
        db.add_column('askbot_post', 'endorsed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='endorsed_posts', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Post.endorsed_at'
        db.add_column('askbot_post', 'endorsed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.endorsed'
        db.delete_column('askbot_post', 'endorsed')

        # Deleting field 'Post.endorsed_by'
        db.delete_column('askbot_post', 'endorsed_by_id')

        # Deleting field 'Post.endorsed_at'
        db.delete_column('askbot_post', 'endorsed_at')
