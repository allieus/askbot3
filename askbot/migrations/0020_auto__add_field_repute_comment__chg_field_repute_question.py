...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('repute', 'comment', self.gf('django.db.models.fields.CharField')(max_length=128, null=True), keep_default=False)

        # Changing field 'Repute.question'
        db.alter_column('repute', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Question'], null=True, blank=True))

    def backwards(self, orm):

        # Deleting field 'Repute.comment'
        db.delete_column('repute', 'comment')

        # Changing field 'Repute.question'
        db.alter_column('repute', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Question']))
