...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('answer', 'accepted_at')

        # Deleting field 'Answer.accepted'
        db.delete_column('answer', 'accepted')

        # Deleting field 'Question.answer_accepted'
        db.delete_column('question', 'answer_accepted')


    def backwards(self, orm):

        # Adding field 'Answer.accepted_at'
        db.add_column('answer', 'accepted_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Answer.accepted'
        db.add_column('answer', 'accepted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Question.answer_accepted'
        db.add_column('question', 'answer_accepted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
