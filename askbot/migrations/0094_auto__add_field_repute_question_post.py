...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('repute', 'question_post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Post'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Repute.question_post'
        db.delete_column('repute', 'question_post_id')
