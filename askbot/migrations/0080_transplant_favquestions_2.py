...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('favorite_question', 'question_id')

        # Changing field 'FavoriteQuestion.thread'
        db.alter_column('favorite_question', 'thread_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['askbot.Thread']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FavoriteQuestion.thread'
        db.alter_column('favorite_question', 'thread_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Thread'], null=True))
