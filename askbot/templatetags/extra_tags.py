...
GRAVATAR_TEMPLATE = """
    <a style="text-decoration:none" href="{user_profile_url}">
        <img class="gravatar" width="{size}" height="{size}"
            src="{gravatar_url}/{gravatar_hash}?s={size}&amp;d={gravatar_type}&amp;r=PG"
            title="{username}" alt="{alt_text}" />
    </a>
"""
