...
from askbot.models import Tag, TagSynonym
...
remove source_tag"""
    ...
    option_list = BaseCommand.option_list + (
        make_option('--from', action='store', type='str', dest='from', default=None,
                    help='a source tag name which needs to be replaced'),
        make_option('--to', action='store', type='str', dest='to', default=None,
                    help='a target tag name that are to be used instead'),
        make_option('--user-id', action='store', type='int', dest='user_id', default=None,
                    help='id of the user who will be marked as a performer of this operation'),
        make_option('--lang', action='store', type='str', dest='lang', default=django_settings.LANGUAGE_CODE,
