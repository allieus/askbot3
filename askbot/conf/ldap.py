...
settings.register(
    livesettings.StringValue(
        ...
        help_text=_('Note that Version 2 protocol is not secure!!! Do not use it on unprotected network.')))


settings.register(livesettings.StringValue(LDAP_SETTINGS, 'LDAP_URL', description=_('LDAP URL'),
