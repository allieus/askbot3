...
from livesettings.values import BooleanValue, IntegerValue, StringValue, LongStringValue, ImageValue


GENERAL_SKIN_SETTINGS = ConfigurationGroup('GENERAL_SKIN_SETTINGS', _('Skin, logos and HTML <head> parts'),
...
register(StringValue(GENERAL_SKIN_SETTINGS, 'LOGO_DESTINATION_URL', default='',
                     description=_('Custom destination URL for the logo'),
                     update_callback=logo_destination_callback))


register(ImageValue(GENERAL_SKIN_SETTINGS, 'SITE_LOGO_URL', description=_('Q&amp;A site logo'),
                    help_text=_('To change the logo, select new file, then submit this whole form.'),
                    default='/images/logo.gif', url_resolver=skin_utils.get_media_url))


# cannot use HAS_ASKBOT_LOCALE_MIDDLEWARE due to circular import error
if 'askbot.middleware.locale.LocaleMiddleware' in django_settings.MIDDLEWARE_CLASSES:
    register(StringValue(GENERAL_SKIN_SETTINGS, 'ASKBOT_LANGUAGE', default=django_settings.LANGUAGE_CODE,
                         choices=django_settings.LANGUAGES, description=_('Select Language')))


register(BooleanValue(GENERAL_SKIN_SETTINGS, 'SHOW_LOGO', description=_('Show logo'),
...
register(ImageValue(GENERAL_SKIN_SETTINGS, 'SITE_FAVICON', description=_('Site favicon'),
                    help_text=_('A small 16x16 or 32x32 pixel icon image '
...
register(LongStringValue(GENERAL_SKIN_SETTINGS, 'CUSTOM_HEADER', default='',
                         description=_('Custom header additions'),
                         help_text=_('Header is the bar at the top of the content '
...
register(StringValue(GENERAL_SKIN_SETTINGS, 'FOOTER_MODE', description=_('Site footer mode'),
                    help_text=_('Footer is the bottom portion of the content, '
                                'which is common to all pages. '
                                'You can disable, customize, or use the default footer.'),
                    choices=(('default', 'default'), ('customize', 'customize'), ('disable', 'disable')),
                    default='default'))


register(LongStringValue(GENERAL_SKIN_SETTINGS, 'CUSTOM_FOOTER', description=_('Custom footer (HTML format)'),
                         help_text=_('<strong>To enable this function</strong>, please select '
...
register(BooleanValue(GENERAL_SKIN_SETTINGS, 'USE_CUSTOM_CSS', description=_('Apply custom style sheet (CSS)'),
                      help_text=_('Check if you want to change appearance '
                                  'of your form by adding custom style sheet rules '
                                  '(please see the next item)'),
                      default=False))


register(LongStringValue(GENERAL_SKIN_SETTINGS, 'CUSTOM_CSS', description=_('Custom style sheet (CSS)'),
                         help_text=_('<strong>To use this function</strong>, check '
...
register(BooleanValue(GENERAL_SKIN_SETTINGS, 'USE_CUSTOM_JS', description=_('Add custom javascript'), default=False,
                      help_text=_('Check to enable javascript that you can enter in the next field')))


register(LongStringValue(GENERAL_SKIN_SETTINGS, 'CUSTOM_JS', description=_('Custom javascript'),
                         help_text=_('Type or paste plain javascript that you would like '
...
register(IntegerValue(GENERAL_SKIN_SETTINGS, 'MEDIA_RESOURCE_REVISION', default=1,
                      description=_('Skin media revision number'),
                      help_text=_('Will be set automatically but you can modify it if necessary.')))


register(StringValue(GENERAL_SKIN_SETTINGS, 'MEDIA_RESOURCE_REVISION_HASH',
                     description=_('Hash to update the media revision number automatically.'),
                     default='',
                     help_text=_('Will be set automatically, it is not necesary to modify manually.')))
